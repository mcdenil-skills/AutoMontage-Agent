...
запасом около 0.1 с тишины у края куска, граница уже в паузе остаётся на месте, разрез, если пауза
позволяет, не ближе 0.04 с к речи, в короткой паузе отдаёт отступ речи, которая остаётся в куске, а
стык соседних кусков одного дубля режется в одной точке. Слова целиком вне запрошенного диапазона и
слова, чья часть внутри куска лежит в тишине на его краю, в транскрипт не переносятся.
