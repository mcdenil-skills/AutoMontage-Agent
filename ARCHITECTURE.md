...
позволяет, не ближе 0.04 с к речи, в короткой паузе встаёт ближе к её середине, а стык соседних
кусков одного дубля режется в одной точке. Слова целиком вне запрошенного диапазона и слова, чья
часть внутри куска лежит в тишине на его краю, в транскрипт не переносятся.
