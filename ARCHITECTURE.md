...
найденную не дальше 0.25 с от неё: у края куска остаётся около 0.1 с тишины и, если пауза
позволяет, не меньше 0.04 с до речи, а стык соседних кусков одного дубля режется в одной точке.
Слова целиком вне запрошенного диапазона и слова, чья часть внутри куска лежит в тишине на его
краю, в транскрипт не переносятся.
