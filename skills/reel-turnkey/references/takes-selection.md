...
- пауза до соседней строки: начало следующей строки минус конец текущей; запас на стыке не
  больше половины этой паузы; если пауза нулевая или отрицательная, режь ровно по границе,
  потому что Whisper часто прячет паузы внутрь слов;
- каждую мысль бери один раз; куски одного дубля не пересекаются, но соседние куски одного
  дубля могут стоять встык;
