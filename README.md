...
### Новая ревизия исходника без пауз и дублей
...
Простая инструкция без технических деталей: [docs/TAKES.md](docs/TAKES.md).
...
### Утверждение и финальный рендер
...
утверждение полного preview. Папки роликов пульт не удаляет и не перемещает. Монтаж, правки и
финальный рендер делает агент: кнопка «Скопировать для агента» даёт готовую фразу для чата.
Подробно – в [инструкции пульта](docs/PULT.md).
...
Текущая версия исходников: **v1.8.0**. Опубликованные сборки находятся на странице
