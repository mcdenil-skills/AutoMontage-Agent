...
иметь звук. Дальше маршрут тот же, но draft,
Review, preview, утверждение и final работают с новой source revision: в `source` draft
указывай абсолютный путь к активному
