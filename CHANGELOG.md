...
- «Пульт роликов» (`automontage pult`): русский главный экран со всеми роликами из `projects/`
  ...
  `automontage inbox` передаёт агенту правки и утверждённые ролики без финала. Утверждение
  архивного ролика без финала остаётся во входящих с пометкой «в архиве – не начинай без
  просьбы пользователя»; новые правки того же ролика показываются как обычно.
