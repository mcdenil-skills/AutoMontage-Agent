...
- `--autotheme` берёт характерные кадры со всего видео: раньше ffmpeg повторял первый из них
  20 раз, и при `--brandLock` меньше 1 цвет темы определяли только первые ~4 с ролика (#33).
