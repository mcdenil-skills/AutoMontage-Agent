...
мс; поиск не дальше 0.25 с; у края куска около 0.1 с тишины (с точностью до кадра) и, если пауза
позволяет, не меньше 40 мс до речи. Конец куска предпочитает паузу до себя, начало после себя,
потому что Whisper растягивает слова в паузы. Стык соседних кусков одного дубля (или зазор меньше
кадра) – один общий разрез, иначе слово между двумя паузами терялось. Граница без паузы рядом
