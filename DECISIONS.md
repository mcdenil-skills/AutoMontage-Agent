...
смена квантизатора, часть – исправленная выборка кадров со всего видео. При `--brandLock 1` (по
умолчанию) все восемь цветовых токенов совпали побайтно, при 0.5 и 0 они сдвинулись на 1–5
единиц канала, контраст текста остался не ниже 5.6:1.
